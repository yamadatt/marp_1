...
const package_prefix_1 = require("./package-prefix");
...
class TextLintModuleResolver {
    constructor(config) {
        ...
        this.tryResolvePackagePath = (modulePath) => {
            ...
            const ret = (0, resolver_1.tryResolve)(modulePath, {
...
`);
    ...
    resolveConfigPackageName(packageName) {
        ...
        const pkgPath = (0, resolver_1.tryResolve)(path.join(baseDir, fullPackageName), {
            parentModule: "config-loader"
        }) ||
            (0, resolver_1.tryResolve)(path.join(baseDir, packageName), {
                parentModule: "config-loader"
            });
        if (!pkgPath) {
