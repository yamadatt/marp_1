...
const rule_map_1 = require("../../engine/rule-map");
const processor_map_1 = require("../../engine/processor-map");
const config_1 = require("../config");
const old_find_util_1 = require("../../util/old-find-util");
const textlint_module_loader_1 = require("./textlint-module-loader");
...
const separate_by_availability_1 = require("../../util/separate-by-availability");
...
class AbstractTextLintEngine {
    ...
    constructor(options) {
        ...
        const cacheBaker = new cache_backer_1.CacheBacker(this.config);
        ...
        this.moduleLoader.on(textlint_module_loader_1.TextLintModuleLoader.Event.rule, ([ruleName, ruleCreator]) => {
            this.ruleMap.defineRule(ruleName, ruleCreator);
        });
        this.moduleLoader.on(textlint_module_loader_1.TextLintModuleLoader.Event.filterRule, ([ruleName, ruleCreator]) => {
            this.filterRuleMap.defineRule(ruleName, ruleCreator);
        });
        this.moduleLoader.on(textlint_module_loader_1.TextLintModuleLoader.Event.plugin, ([pluginName, plugin]) => {
...
new TextLintEngine({
 rulesBaseDirectory: directory
    ...
    executeOnFiles(files) {
        ...
        const patterns = (0, old_find_util_1.pathsToGlobPatterns)(files, {
            extensions: this.textlintrcDescriptor.availableExtensions
        });
        const targetFiles = (0, old_find_util_1.findFiles)(patterns, { ignoreFilePath: this.config.ignoreFile });
        ...
        const { availableFiles, unAvailableFiles } = (0, separate_by_availability_1.separateByAvailability)(targetFiles, {
            extensions: this.textlintrcDescriptor.availableExtensions
        });
    ...
    executeOnText(text, ext = ".txt") {
        ...
        // filePath or ext
        const actualExt = ext[0] === "." ? ext : path_1.default.extname(ext);
